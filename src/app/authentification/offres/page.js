...
export default function OffreSelection() {
  ...
  const handleSubmit = async (offreId) => {
    ...
    router.push("/authentification/offres/inscription");
      ...
      alert(`Erreur lors de la sélection de l'offre`);
    }
  };
  return (
    <div
              ...
              >
                <div className="flex justify-around items-stretch space-x-4">
                  <div className="bg-gray-100 p-6 rounded-lg flex-1">
                    <button onClick={() => handleSubmit(offre.id)} className="bg-gradient-to-b from-greener-950 to-emeralder-900 w-full text-slate-50 pl-2">
