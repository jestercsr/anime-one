  ...
  return (
    <div className="pt-14 bg-gradient-to-b from-greener-400 to-greener-950 text-white">
      <div className="bg-skyer-500 flex text-center justify-around">
        <div className="">
          <img src="assets/iconoir--cinema-old.svg" alt="iconeCinema" className="w-1/5 m-auto" />
        ...
        <div className="ml-2.5">
          <img src="assets/devices-solid.svg" alt="iconeDevices" className="w-1/5 m-auto" />
        ...
        <div className="ml-2.5">
          <img src="assets/users-solid.svg" alt="iconeUsers" className="w-1/6 m-auto" />
