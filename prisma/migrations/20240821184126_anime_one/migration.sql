...
CREATE TABLE "User" (
    ...
    "prenom" VARCHAR(255) NOT NULL DEFAULT 'Bonjour',
    "nom" VARCHAR(255) NOT NULL DEFAULT 'Aurevoir',
    "email" VARCHAR(255) NOT NULL,
    "password" VARCHAR(32) NOT NULL,
    "adresse" VARCHAR(255) NOT NULL DEFAULT '1 Rue du Pirate',
    "phone" VARCHAR(12) NOT NULL DEFAULT '0612345678',
