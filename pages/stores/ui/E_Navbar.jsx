...
export default function E_Navbar(pageContext) {
  const menuL = [
    {
      name: "Nouveautés",
      href: "/stores/news",
  ...
  return (
    <div className="duration-200 z-40 bg-cyan-800 text-slate-50 w-full">
      <div className="bg-sky-500 text-slate-50 ">
        <div className="container py-2">
          <div className="flex justify-between items-center text-sm">
            <a href="/accueil" className="hover:text-orange-500">
      ...
      >
        ...
        <div
          className={`${isOpen ? "flex items-baseline" : "flex items-center"}`}
        >
          ...
          <section
            className={`${isOpen ? "flex w-8 h-8 items-baseline" : "items-center ml-2 lg:gap-6"}`}
          >
            {avatarUrl && profileName ? (
              <div className="relative">
                <a href="/stores/profile">
                  <img
                    src={
