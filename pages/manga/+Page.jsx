...
export default function PageListe() {
  ...
  return (
    <div className="bg-gradient-to-b from-sky-600 to-emeralder-900">
      {userProfile ? (
        <Navbar
          className="bg-green-400 text-blue-900"
          liste="bg-green-300 text-blue-900 absolute left-0 w-full divide-y-2 divide-slate-50 border-gray-300 mt-1 z-10 list-none"
          listing="cursor-pointer p-2 hover:bg-gray-200 hover:text-green-700 border-t-0"
        />
      ) : (
        <nav className="flex justify-end p-1 bg-neutraler-50">
          <a href="/authentification">
            <button
              aria-label="clik-me-auth"
              className="bg-red-600 text-slate-50 p-2 rounded-xl"
            >
              S'identifier
            </button>
          </a>
