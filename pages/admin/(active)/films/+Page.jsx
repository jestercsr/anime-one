    ...
    const fetchData = async () => {
      try {
        const moviesData = await fetch(
          import.meta.env.VITE_API_URL + "/posts/listes/films",
        ).then((res) => res.json());
        setDataFilm(moviesData);
        setLoading(false);
      } catch (error) {
        console.error("Erreur pour recuperer la liste des films:", error);
        setLoading(false);
      }
    };
    fetchData();
            ...
            return (
              ...
              >
                ...
                <div className="p-6 justify-center">
                  <h2 className="text-lg line-clamp-2 lg:h-[60px] font-bold text-gray-900">
                    {films.name}
                  </h2>
