    ...
    <main className="max-w-5xl mx-auto px-6 py-12">
      ...
      <section className="mb-6">
        ...
        <p className="text-gray-700">
          Le site{" "}
          <a href={"https://anime-one-project.vercel.app"}>
            https://anime-one-project.vercel.app
          </a>{" "}
          est édité par Jester CESAR, étudiant développeur web pour l'obtention
          du diplôme de Concepteur Développeur d'Applications (CDA).
        </p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="text-gray-700">
          Ce site est hébergé par Vercel Inc., situé à 440 N Barranca Avenue
          #4133, Covina, CA 91723, United States.
          <br />
          Pour plus d'informations, contactez Vercel directement sur{" "}
          <span className="text-blue-600">privacy@vercel.com</span>
        </p>
      </section>

      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-3">Nous contacter</h2>
        <p className="text-gray-700">Par email : jester.csr@gmail.com</p>
      </section>
      ...
      <section className="mb-6">
        ...
        <p className="text-gray-700">
          ...
          graphismes) sont la propriété d'Anime One, sauf mention contraire.
      ...
      <section>
        ...
        <p className="text-gray-700">
          Conformément au Règlement Général sur la Protection des Données du 27
          avril 2016 (RGPD), vous disposez d’un droit d’accès, de rectification
